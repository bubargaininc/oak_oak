...
<div class="content">
    <div class="seller mb10">
        <div class="inner1024 posr">
            <div class="seller-name" style="border:none">商品讨论</div>
        </div>
    </div>
...
-->
        ...
        <div class="disciussion-info1 fl">
            <div class="dcsii">
                <span><b class=" opensans"><?php echo $output['goods_detail']['goods_info']['goods_collect']?></b><i class="ae-like-on"></i></span>
                <span>评论：<b class=" opensans"><?php echo count($output['taolun'])?></b> 人</span>
                <span>月销量：<b class="bluetxt opensans"><?php echo $output['goods_detail']['goods_info']['evaluation_count']?></b> 件</span>
            </div>
