...
<div class="content">
    <div class="seller mb10">
        <div class="inner1024 posr">
            <div class="seller-name" style="border:none">商店讨论</div>
        </div>
    </div>
...
?>
            ...
            <div class="baby-name"><?php echo $GLOBALS['setting_config']['site_name']; ?><span class="baby-year">
...
-->
        ...
        <div class="disciussion-info1 fl">
            <div class="dcsii">
                <span><b class=" opensans">0</b><i class="ae-like-on"></i></span>
                <span>评论：<b class=" opensans">0</b> 人</span>
        ...
        <div class="disciussion-info5 fl ">
            ...
            <div class="clearfix recommend">
                ...
                <div class="bd">
 <?php 
 if(is_array($output['hot_sales']) && !empty($output['hot_sales'])){?>
 <?php foreach($output['hot_sales'] as $val){?>
                    ...
                    <div class="hdr">
                        ...
                        <div class="meta">
                            <div><a href="<?php echo urlShop('goods', 'index',array('goods_id'=>$val['goods_id']));?>">BABYBIO</a></div>
                 ...
                 <span class="like"><a href="javascript:collect_goods('<?php echo $value['goods_id']; ?>','count','goods_collect');" ><em nctype="goods_collect"><?php echo $value['goods_collect']?></em><i class="ae-like"></i></a></span>|
                    <a class="listing" href="javascript:collect_yuan('<?php echo $output['goods']['goods_id']; ?>','count','goods_collect');" target="_blank">
        ...
        <div class="dir">
            ...
            <ul class="commetlist clearfix">
                <?php if(is_array($output['hot_sales']) && !empty($output['hot_sales'])){?>
                 <?php foreach($output['hot_sales'] as $val){?>
                                <li>
                                    <a href="" class="cover"><img src="<?php echo thumb($val, 120);?>" alt=""></a>
         ...
         <?php
          foreach($output['hot_collect'] as $val){?>
            ...
            <div class="ftr" style="display: none;">
                ...
                <div class="meta">
                    <span class="like"><?php echo $val['goods_collect']?><i class="ae-like"></i></span> | 
...
var goods_id="<?php echo $_GET['store_id']?>";
var type='2';
