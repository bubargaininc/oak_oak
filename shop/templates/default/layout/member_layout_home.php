...
<div class="order-menu personal-menu">
        <div class="inner1024 clearfix">
            <i class="ae-personal"></i>
            <ul>
                <li class="fz18"><a href="<?php echo urlShop('home','cheng')?>">我的主页</a></li>
                <li class="<?php echo $output['index']=='cheng'?'on':''; ?>"><a href="<?php echo urlShop('home','cheng')?>">我的成长纪录</a></li>
                <li class="<?php echo $output['index']==='message'?'on':''; ?>"><a href="<?php echo urlShop('home','message')?>">我收到的私信</a></li>
    ...
    <div class="order-notice inner1024">
        ...
        <a id="zhuye" nctype="buynow_submit" href="javascript:void(0)" class="goanyway"><img src="<?php echo SHOP_TEMPLATES_URL;?>/img/order/ae-order-go.png" alt="">订单</a>
    </div>
    <script>
            //显示分享店铺页面
    ...
    <div class="order-main clearfix inner">
        <div class="order-sidebar clearfix">
            <div class="describe clearfix">
                <div class="avatar">
                  <img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']); ?>" onload="javascript:DrawImage(this,100,100);" alt="<?php echo $output['member_info']['member_name']; ?>" />
...
?>
                ...
                <?php echo empty($output['member_info']['member_truename'])? $output['member_info']['member_name']:$output['member_info']['member_truename'];?><i>/</i><span>
                    <?php if($bgtime['mon']!=='0'){
                        echo $bgtime['mon'].'个月';
                    }elseif($bgtime['day']!=='0'){
                        echo $bgtime['day'].'天';
