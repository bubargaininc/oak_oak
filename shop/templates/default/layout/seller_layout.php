...
<div id="ajaxwaitid"></div><?php if (!empty($output['store_closed'])) { ?>
  <div class="store-closed"><i class="icon-warning-sign"></i>
    <dl>
      <dt>Your shop has been closed down</dt>
      <dd>Close cause:<?php echo $output['store_close_info'];?></dd>
      <dd>During this time, your shop and the goods will not be able to visit; if you have a complaint or complaint please contact the platform management</dd>
    </dl>
  </div>
  <?php } ?>
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function"><a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$_SESSION['store_id']), $output['store_info']['store_domain']);?>" target="_blank" title="Go to the shop" ><i class="icon-home"></i></a><a href="<?php echo urlShop('home', 'message');?>" title="Station message" class="pr" target="_blank"><i class="icon-envelope-alt"></i><em><?php echo $output['message_num'];?></em></a><a href="<?php echo urlShop('home', 'passwd');?>" title="Change password" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="Safe exit"><i class="icon-signout"></i></a></div>
    </div>
    ...
    <div class="index-search-container">
      <div class="index-sitemap"><a href="javascript:void(0);">Navigation<i class="icon-angle-down"></i></a>
        <div class="sitemap-menu-arrow"></div>
        <div class="sitemap-menu">
          <div class="title-bar">
            <h2>
            <i class="icon-sitemap"></i>Management navigation<em>Tip: to add page sidebar you often use, convenient operation。</em>
            </h5>
      ...
      <div class="search-bar">
        <form method="get" target="_blank">
          ...
          <input type="text" nctype="search_text" name="keyword" placeholder="Mall product search" class="search-input-text">
    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <?php } ?>
          <?php } ?><div class="add-quickmenu"><a href="javascript:void(0);"><i class="icon-plus"></i>Add the common menu</a></div>
        </ul>
      </div>
    </div>
  </div>
  <div id="layoutRight" class="ncsc-layout-right">
    <div class="ncsc-path"><i class="icon-desktop"></i>Business management center<i class="icon-angle-right"></i><?php echo $output['current_menu']['model_name'];?><i class="icon-angle-right"></i><?php echo $output['current_menu']['name'];?></div>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_add_quicklink"]').on('click', function() {
        ...
        if($quicklink_item.hasClass('selected')) {
            ...
            if(count >= 8) {
                showError('Shortcut operation up to add 8');
            } else {
...
<?php require_once template('footer2');?>
