                 ...
                 <?php foreach($group_info['order_list'] as $order_id => $order_info) {?>
                    <div class="order-shop-tit clearfix">
                        <div class="order-shop-commodity fl">
                            <span class="shop-name mr25">店铺：<a href="<?php echo urlShop('show_store','index',array('store_id'=>$order_info['store_id']), $order_info['extend_store']['store_domain']);?>" target="_blank"><?php echo $order_info['store_name']; ?></a></span>
                        </div>
                ...
                <?php };?>
                    ...
                    <ul class="order-shop-good-list clearfix">
                        <li class="order-shop-good clearfix">
                            ...
                            <!--商品名称-->
                                <div class="osg-tit"><a href="index.php?act=member_order&op=show_order&order_id=<?php echo $order_info['order_id']; ?>" target="_blank"><?php echo $goods_info['goods_name']; ?></a></div>
                             <!--商品图片-->  
                                <div class="osg-pic-price">
                                <td class="w70">
                                    <div class="osg-pic">
                                        <a href="<?php echo urlShop('goods','index',array('goods_id'=>$goods_info['goods_id']));?>" taregte="_blank">
                                            <img src="<?php echo thumb($goods_info,60);?>" alt="">
                                        </a>
                                    </div>
                                    <div class="osg-num-operation" style="text-align:right;"><?php echo $goods_info['goods_num']; ?></div>
                                </div>


                                <div class="osg-operation">
                                    <div class="order-price-show-con fz16 vat">
                                        <span class="price"><?php echo $goods_info['goods_price'];?> </span>
                                    </div>
    ...
    <?php if ($output['order_group_list']) { ?>
      ...
      <tr>
        ...
        <span class="fl ml10">
            ...
            <!-- store_name -->
            <span class="fl ml10">
            <a href="" target="_blank" title="<?php echo $order_info['store_name'];?>"></a></span>
