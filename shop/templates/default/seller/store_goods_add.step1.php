...
<div class="wrapper_search">
  <div class="wp_sort">
    ...
    <div class="sort_selector">
      <div class="sort_title"><span><?php echo $lang['store_goods_step1_choose_common_category'];?></span>
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <div class="bottom tc">
      <label class="submit-border"><input disabled="disabled" nctype="buttonNextStep" value="<?php echo $lang['store_goods_add_next'];?>, fill out the product information" type="submit" class="submit"style=" width: 200px;" /></label>
      </div>
    </form>
  </div>
</div>
