<div class="eject_con">
  ...
  <form method="post" action="<?php echo urlShop('store_goods_online', 'edit_jingle');?>" id="jingle_form">
    ...
    <dl>
      <dt>Commodity advertising words:</dt>
      <dd>
        <input type="text" class="text w300" name="g_jingle" id="g_jingle" value="" />
        <p class="hint">If not all advertisements will fill, air, please be careful</p>
      </dd>
    </dl>
    <div class="bottom">
...
$(function(){
    $('#jingle_form').validate({
        ...
        messages : {
            g_jingle : {
                maxlength: '<i class="icon-exclamation-sign"></i>No more than 50 characters'
            }
        }
    });
});
