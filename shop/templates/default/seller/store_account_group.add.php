...
<div class="ncsc-form-default">
  <form id="add_form" action="<?php echo urlShop('store_account_group', 'group_save');?>" method="post">
    ...
    <?php } ?>
    <dl>
      <dt><i class="required">*</i>Group name<?php echo $lang['nc_colon'];?></dt>
    ...
    <dl>
      <dt><i class="required">*</i>Jurisdiction<?php echo $lang['nc_colon'];?></dt>
      <dd><input id="btn_select_all" type="checkbox" />
          <label for="btn_select_all">Select</label>
...
$(document).ready(function(){
    ...
    $('#add_form').validate({
        ...
        messages: {
            seller_group_name: {
                required: '<i class="icon-exclamation-sign"></i>Group name cannot be empty',
                maxlength: '<i class="icon-exclamation-sign"></i>Group name up to 50 words' 
            }
        }
    });
