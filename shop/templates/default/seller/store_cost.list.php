...
<table class="ncsc-table-style">
  <thead>
    <tr>
      <th class="w120">Consumption amount</th>
      <th class="tl">Consumption content</th>
      <th class="w80">State</th>
      <th class="w130">Time</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php echo $value['cost_state']?'Settled':'Not settled';?></td>
