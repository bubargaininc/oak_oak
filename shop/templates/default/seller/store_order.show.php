...
<div class="wrap-all ncu-order-view">
  ...
  <table class="ncsc-table-style">
    <thead>
      <tr>
        ...
        <th class="w100">Actual payment</th>
        <th class="w100">Commission ratio</th>
        <th class="w100">Pay commission</th>
      </tr>
    </thead>
    <tbody>
  ...
  <div style="height:30px;line-height:30px;">
    ...
    <span style="color:red">Full free</span> <?php echo $output['order_info']['extend_order_common']['promotion_info'];?>
    <?php } ?>
    <?php if(!empty($output['order_info']['extend_order_common']['voucher_code'])){ ?>
    <span style="color:red">Vouchers</span> Denomination : <?php echo $output['order_info']['extend_order_common']['voucher_price'];?>
     Code : <?php echo $output['order_info']['extend_order_common']['voucher_code'];?></a>
    <?php } ?>
  </div>
  <!-- E 促销信息 -->
  <?php } ?>
...
<!-- 退款记录 -->
  ...
  <li> Time<?php echo $lang['nc_colon'];?><?php echo date("Y-m-d H:i:s",$val['admin_time']); ?>&emsp;&emsp;No refund<?php echo $lang['nc_colon'];?><?php echo $val['refund_sn'];?>&emsp;&emsp;Refund amount<?php echo $lang['nc_colon'];?><?php echo $lang['currency'];?><?php echo $val['refund_amount']; ?>&emsp;Remarks<?php echo $lang['nc_colon'];?><?php echo $val['goods_name'];?></li>
  <?php } ?>
  </ul>
  <?php } ?>
