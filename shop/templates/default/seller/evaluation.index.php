...
<form method="get">
  <table class="search-form">
    ...
    <tr>
      <td>&nbsp;</td>
      <th class="w110">Commodity name</th>
...
<table class="ncsc-table-style">
    <thead>
        <tr>
            <th class="w10"></th>
            <th class="tl">Evaluation information</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>
                ...
                <span>Commodity evaluation:<em class="raty" data-score="<?php echo $v['geval_scores'];?>"></em></span>
                <span>Evaluation person:<?php echo $v['geval_frommembername'];?> <time>[<?php echo date('Y-m-d H:i:s',$v['geval_addtime']);?>]</time></span>
            </th>
            <th></th>
        </tr>
        <tr>
        ...
        <tr class="bd-line" >
            <td class="tl" colspan="20">
                <div <?php echo empty($v['geval_explain'])?'style="display:none;"':''?>>
                    <strong>Explanation content:</strong>
...
<div id="dialog_explain" style="display:none;">
    <div class="eject_con">
        ...
        <dl>
            <dt>Explanation content:</dt>
            <dd id="geval_content"></dd>
        </dl>
        <dl>
            <dt><i class="required">*</i>Explanation content:</dt>
            <dd>
            <textarea id="geval_explain" cols="30" rows="10"></textarea>
            </dd>
        </dl>
        <div class="bottom">
            <a href="javascript:void(0);" id="btn_explain_submit" class="submit">Determine</a>
        </div>
    </div>
</div>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_show_explain_dialog"]').on('click', function() {
        ...
        $('#geval_explain').val('');
        $('#dialog_explain').nc_show_dialog({title:'Interpretation Evaluation'});
        });
