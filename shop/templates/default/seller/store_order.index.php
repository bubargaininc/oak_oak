...
<?php if ($order['if_deliver']) { ?>
        ...
        <a href="index.php?act=store_order_print&order_id=<?php echo $order_id;?>" class="ncsc-btn-mini" target="_blank" title="Print invoices"/><i class="icon-print"></i>Print invoices</a></span>
    ...
    <tr>
      ...
      <td class="bdl" rowspan="<?php echo count($order['extend_order_goods']);?>"><p class="ncsc-order-amount">￥<?php echo $order['order_amount']; ?></p>
        ...
        <p class="goods-freight">
          ...
          (<?php echo $lang['store_show_order_shipping_han']?>Freight<?php echo $order['shipping_fee'];?>)
          <?php }else{?>
      ...
      <td class="bdl bdr" rowspan="<?php echo count($order['extend_order_goods']);?>">
        ...
        <p><a href="javascript:void(0)" class="ncsc-btn-mini ncsc-btn-orange mt10" uri="index.php?act=store_order&op=change_state&state_type=modify_price&order_sn=<?php echo $order['order_sn']; ?>&order_id=<?php echo $order['order_id']; ?>" dialog_width="480" dialog_title="<?php echo $lang['store_order_modify_price'];?>" nc_type="dialog"  dialog_id="seller_order_adjust_fee" id="order<?php echo $order['order_id']; ?>_action_adjust_fee" /><i class="icon-pencil"></i>Modified freight</a></p>
        <?php }?>
