  ...
  <div class="div-goods-select">
    <form method="GET">
      ...
      <table class="search-form">
        <tr>
          <th class="w250"><strong>Select the product to participate in activities, check and submit the platform audit</strong></th>
          <td class="w160"><input type="text" class="text w150" name="name" value="<?php echo $output['search']['name'];?>" placeholder="Search product name"/></td>
