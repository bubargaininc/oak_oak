...
<head>
<meta charset="utf-8" />
<title>Business management center login</title>
...
$(document).ready(function() {
    $("#form_login").validate({
        ...
        messages:{
            seller_name:{
                required:"<i class='icon-exclamation-sign'></i>User name can not be empty"
            },
            password:{
                required:"<i class='icon-exclamation-sign'></i>Password can not be empty"
            },
            captcha:{
                required:"<i class='icon-exclamation-sign'></i>Verification code can not be empty",
                remote:"<i class='icon-frown'></i>Verification code error"
            }
        }
    });
...
<div class="ncsc-login-container">
  <div class="ncsc-login-title">
    <h2>Business management center</h2>
    <span>Please enter the business name you apply for when you sign up.</br>
    Login password for mall user password</span></div>
  <form id="form_login" action="index.php?act=seller_login&op=login" method="post" >
    ...
    <div class="input">
      ...
      <input type="submit" class="login-submit" value="Merchant login">
    </div>
  </form>
