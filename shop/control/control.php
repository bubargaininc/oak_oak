...
class BaseStoreControl extends Control {
	...
	protected function outputStoreInfo($store_info){
        ...
        //热销排行
        $hot_sales = $model_store->getHotSalesList($store_info['store_id'], 4);
        foreach ($hot_sales as $key => $value) {
	$hot_sales[$key]['goods_count']=Model('count')->getCount($value['goods_count']);
}

        Tpl::output('hot_sales', $hot_sales);

        //收藏排行
        $hot_collect = $model_store->getHotCollectList($store_info['store_id'], 4);
...
class BaseSellerControl extends Control {
    ...
    private function _getMenuList() {
       /* $menu_list = array(
           ...
           $menu_list = array(
            'goods' => array('name' => 'Commodity', 'child' => array(
                array('name' => 'Product release', 'act'=>'store_goods_add', 'op'=>'index'),
				array('name' => 'Clean out treasure', 'act'=>'taobao_import', 'op'=>'index'),
                array('name' => 'Sale of goods', 'act'=>'store_goods_online', 'op'=>'index'),
                array('name' => 'Goods in the warehouse', 'act'=>'store_goods_offline', 'op'=>'index'),
                array('name' => 'Stock alarm', 'act'=>'store_storage_alarm', 'op' => 'index'),
                array('name' => 'Associated plate', 'act'=>'store_plate', 'op'=>'index'),
                array('name' => 'Specifications', 'act' => 'store_spec', 'op' => 'index'),
            ...
            'order' => array('name' => 'Order', 'child' => array(
                ...
                array('name' => 'Deliver goods', 'act'=>'store_deliver', 'op'=>'index'),
                array('name' => 'Delivery settings', 'act'=>'store_deliver_set', 'op'=>'daddress_list'),
                array('name' => 'Evaluation management', 'act'=>'store_evaluate', 'op'=>'list'),
                array('name' => 'Print setup', 'act'=>'store_printsetup', 'op'=>'index'),
            )),
            'promotion' => array('name' => 'Promotion', 'child' => array(
                array('name' => 'Group purchase management', 'act'=>'store_groupbuy', 'op'=>'index'),
                array('name' => 'Limited time discount', 'act'=>'store_promotion_xianshi', 'op'=>'xianshi_list'),
                array('name' => 'Full free', 'act'=>'store_promotion_mansong', 'op'=>'mansong_list'),
                array('name' => 'Preferential suit', 'act'=>'store_promotion_bundling', 'op'=>'bundling_list'),
                array('name' => 'Recommended booth', 'act' => 'store_promotion_booth', 'op' => 'booth_goods_list'),
                array('name' => 'Voucher management', 'act'=>'store_voucher', 'op'=>'templatelist'),
                array('name' => 'Activity management', 'act'=>'store_activity', 'op'=>'store_activity'),
            )),
            'store' => array('name' => 'Shop', 'child' => array(
                array('name' => 'Shop setting', 'act'=>'store_setting', 'op'=>'store_setting'),
                array('name' => 'Shop navigation', 'act'=>'store_navigation', 'op'=>'navigation_list'),
                array('name' => 'Shop Dynamic', 'act'=>'store_sns', 'op'=>'index'),
                array('name' => 'Store information', 'act'=>'store_info', 'op'=>'store_info'),
                array('name' => 'Shop category', 'act'=>'store_goods_class', 'op'=>'index'),
                array('name' => 'Brand application', 'act'=>'store_brand', 'op'=>'brand_list'),
            )),
            'transport' => array('name' => 'Logistics', 'child' => array(
                array('name' => 'Logistics tools', 'act'=>'store_transport', 'op'=>'index'),
                array('name' => 'Free shipping amount', 'act'=>'store_free_freight', 'op'=>'index'),
            )),
            'consult' => array('name' => 'Pre sale', 'child' => array(
                array('name' => 'Customer service settings', 'act'=>'store_callcenter', 'op'=>'index'),
            ...
            'statistics' => array('name' => 'Statistics', 'child' => array(
                ...
                array('name' => 'Purchase rate statistics', 'act'=>'statistics_probability', 'op'=>'probability_statistics'),
            )),
            'account' => array('name' => 'Account', 'child' => array(
                ...
                array('name' => 'Store consumption', 'act'=>'store_cost', 'op'=>'cost_list'),
            ))
        );
        return $menu_list;
    }
