...
class store_refundControl extends BaseSellerControl {
	...
	private function profile_menu($menu_type,$menu_key='') {
		...
		switch ($menu_type) {
			case 'refund':
				$menu_array = array(
					array('menu_key'=>'2','menu_name'=>'Pre sale refund',	'menu_url'=>'index.php?act=store_refund&lock=2'),
					array('menu_key'=>'1','menu_name'=>'After sale refund','menu_url'=>'index.php?act=store_refund&lock=1')
				);
				break;
		}
