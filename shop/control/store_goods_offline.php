...
class store_goods_offlineControl extends BaseSellerControl {
    ...
    private function profile_menu($menu_key = '') {
        $menu_array = array(
            array('menu_key' => 'goods_storage',    'menu_name' => 'Goods in the warehouse',   'menu_url' => urlShop('store_goods_offline', 'index')),
            array('menu_key' => 'goods_lockup',     'menu_name' =>'Illegal goods',     'menu_url' => urlShop('store_goods_offline', 'index', array('type' => 'lock_up'))),
            array('menu_key' => 'goods_verify',     'menu_name' => 'Waiting for the audit of the goods',    'menu_url' => urlShop('store_goods_offline', 'index', array('type' => 'wait_verify')))
        );
