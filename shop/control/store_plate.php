...
class store_plateControl extends BaseSellerControl {
    ...
    private function profile_menu($menu_type,$menu_key='',$array=array()) {
        ...
        switch ($menu_type) {
            case 'plate_list':
                $menu_array = array(
                    array('menu_key' => 'plate_list', 'menu_name' => 'Format list', 'menu_url' => urlShop('store_plate', 'plate_list'))
                );
                break;
            case 'plate_add':
                $menu_array = array(
                    array('menu_key' => 'plate_list', 'menu_name' => 'Format list', 'menu_url' => urlShop('store_plate', 'plate_list')),
                    array('menu_key' => 'plate_add', 'menu_name' => 'Add format', 'menu_url' => urlShop('store_plate', 'plate_add'))
                );
                break;
            case 'plate_edit':
                $menu_array = array(
                    array('menu_key' => 'plate_list', 'menu_name' => 'Format list', 'menu_url' => urlShop('store_plate', 'plate_list')),
                    array('menu_key' => 'plate_add', 'menu_name' => 'Add format', 'menu_url' => urlShop('store_plate', 'plate_add')),
                    array('menu_key' => 'plate_edit', 'menu_name' => 'Edit format', 'menu_url' => urlShop('store_plate', 'plate_edit'))
                );
                break;
        }
        if(!empty($array)) {
