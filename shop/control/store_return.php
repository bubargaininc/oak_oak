...
class store_returnControl extends BaseSellerControl {
	...
	private function profile_menu($menu_type,$menu_key='') {
		...
		switch ($menu_type) {
			case 'return':
				$menu_array = array(
					array('menu_key'=>'2','menu_name'=>'Pre sale return',	'menu_url'=>'index.php?act=store_return&lock=2'),
					array('menu_key'=>'1','menu_name'=>'After sale refund','menu_url'=>'index.php?act=store_return&lock=1')
				);
				break;
		}
