    ...
    public function save_goodsOp() {
        if (chksubmit()) {
            ...
            $common_array['goods_costprice']    = floatval($_POST['g_costprice']);
             //欧元价
             $common_array['goods_ouprice']    = $_POST['g_ouprice'];


             //欧元连接
             $common_array['goods_oulink']    = $_POST['g_oulink'];
            //选择国家
             $common_array['goods_count']    = $_POST['g_count'];
            //设计师
             $common_array['goods_sheji']    = $_POST['g_sheji'];
		   ...
		   if ($common_id) {
                ...
                if (is_array($_POST['spec'])) {
                    ...
                    $goods['goods_commend']     = $common_array['goods_commend'];
                    $goods['goods_stcids']      = $common_array['goods_stcids'];
                    $goods['goods_count']      =  $common_array['goods_count'];
                    $goods['goods_sheji']      =  $common_array['goods_sheji'];
                    $goods['goods_oulink']      =  $common_array['goods_oulink'];
                    $goods['goods_ouprice']      =  $common_array['goods_ouprice'];
