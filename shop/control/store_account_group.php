    ...
    public function group_editOp() {
        ...
        if (empty($seller_group_info)) {
           // showMessage('组不存在', '', '', 'error');
             showMessage('Groups do not exist', '', '', 'error');
        }
    ...
    public function group_saveOp() {
        ...
        if (empty($_POST['group_id'])) {
           ...
           // showDialog('添加成功', urlShop('store_account_group', 'group_list'),'succ');
              showDialog('Add success', urlShop('store_account_group', 'group_list'),'succ');
        } else {
            $condition = array();
            ...
            showDialog('Edit success', urlShop('store_account_group', 'group_list'),'succ');
        }
    }
