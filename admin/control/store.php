...
class storeControl extends SystemControl{
	...
	public function store_editOp(){
		...
		if (chksubmit()){
            ...
            $update_array['store_text'] = $_POST['store_text'];
            $update_array['store_ziwo'] = $_POST['store_ziwo'];
            $update_array['store_work'] = $_POST['store_work'];
            $update_array['store_hun'] = $_POST['store_hun'];
            $update_array['store_juzhu'] = $_POST['store_juzhu'];
            $update_array['store_ping'] = $_POST['store_ping'];
            $update_array['store_add'] = $_POST['store_add'];
        ...
        if (!empty($_FILES['site_logo']['name'])){
                ...
                if ($result){
                    $update_array['store_label'] = $upload->file_name;
                }else {
              ...
              if (!empty($_FILES['member_logo']['name'])){
                ...
                if ($result){
                    $update_array['store_logo'] = $upload->file_name;
                }else {
                    showMessage($upload->error,'','','error');
                }
            }
         ...
         //   $update_array['store_brand'] = $_POST['store_brand'];
