...
<div class="page">
  ...
  <form method="post" id="form_member">
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          <th class="align-center"><span fieldname="logins" nc_type="order_by">店铺名称</span></th>
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center">
            <a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_store&op=taolun&store_id=<?php echo $v['goods_id']; ?>" target="_blank">查看</a>
   
<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=account&op=taolun_del2&del_count_id=<?php echo $v['id'];?>';}else{return false;}">删除</a> 
           </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
