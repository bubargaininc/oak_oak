      ...
      <tbody>
        ...
        <tr class="noborder">
          ...
          <select name="brand_count">
              ...
              <option value="<?php echo $v['count_id'];?>" 
              <?php echo $output['brand_array']['brand_count']==$v['count_id']?"selected":"";?>
              ><?php echo $v['count_name'];?></option>
              <?php }?>
          </select>
          </td> 
        </tr>
       ...
       <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
             <textarea class="tarea" id="brand_about" name="brand_about"> <?php echo $output['brand_array']['brand_about']?></textarea>
        ...
        <tr class="noborder" style="display:none">
          ...
          <span class="type-file-show"> <img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            ...
            <img id="view_img" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_BRAND.'/'.$output['brand_array']['brand_pic']; ?>">
            </div>
            </span> 
