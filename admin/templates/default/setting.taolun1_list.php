...
<div class="page">
  ...
  <form method="post" id="form_member">
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          <th class="align-center"><span fieldname="logins" nc_type="order_by">商品名称</span></th>
...
<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=account&op=taolun_del&del_count_id=<?php echo $v['id'];?>';}else{return false;}">删除</a> 
           </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
